...
if (!wpId) {
  const info = db.prepare('INSERT INTO workplaces (name,address,lat,lng,radius_m) VALUES (?,?,?,?,?)')
    .run('Главный офис', 'г. Ташкент, ул. Амира Темура 1', 41.311081, 69.240562, 150);
  wpId = info.lastInsertRowid;
  db.prepare('INSERT INTO workplaces (name,address,lat,lng,radius_m) VALUES (?,?,?,?,?)')
    .run('Склад №1', 'г. Ташкент, Сергелийский р-н', 41.230000, 69.230000, 200);
